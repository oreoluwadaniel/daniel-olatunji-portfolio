...
const featuredSlugs = ["weatherintel", "data-analytics-etl", "bloomcrest-revenue-intelligence", "everdale-retail-analytics"];
...
export default function Home() {
  ...
  return <main>
    <section className="hero"><div className="container hero-grid"><div className="hero-copy">
      ...
      <p>Four years spent on revenue, customers, risk, logistics and the data-quality problems sitting underneath all of them. Ten case studies, with the evidence and limits stated on each one.</p>
