...
export default function Home() {
  return <main>
    <section className="hero"><div className="container hero-grid"><div className="hero-copy">
      ...
      <p>Four years across revenue, customers, stock, risk and reporting. Five case studies, each built around a business question, the numbers behind it and the decision they support.</p>
