...
const inter = localFont({src:"./fonts/InterVariable.woff2",weight:"100 900",style:"normal",display:"swap",variable:"--font-inter",fallback:["-apple-system","BlinkMacSystemFont","Segoe UI","Roboto","Helvetica","Arial","sans-serif"]});
...
export const metadata: Metadata = {
  ...
  keywords:["data analyst","business intelligence analyst","Power BI developer","SQL analyst","data quality","Lagos","Nigeria","remote data analyst"],
  authors:[{name:"Daniel Olatunji",url:siteUrl}], creator:"Daniel Olatunji", alternates:{canonical:siteUrl},
...
export default function RootLayout({children}:{children:React.ReactNode}) { return <html lang="en-GB" className={inter.variable}><body><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(personSchema)}}/><a className="skip" href="#main">Skip to content</a><Header/><div id="main">{children}</div><Footer/></body></html>; }
